...
set REPO_URL=https://github.com/ponapalt/Style-Bert-VITS2
...
echo --------------------------------------------------
echo Executing: uv pip install "torch>=2.7.0" "torchaudio>=2.7.0" --index-url https://download.pytorch.org/whl/cu118
uv pip install "torch>=2.7.0" "torchaudio>=2.7.0" --index-url https://download.pytorch.org/whl/cu118
if !errorlevel! neq 0 ( pause & popd & exit /b !errorlevel! )
